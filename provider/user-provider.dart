...
class UserProvider extends ChangeNotifier {
  //String? name;
  //String? url;
  File? _tempFileImagePath;
  //String? _tempUserName;
  bool _updatedImagestatus = false;
  ...
  File? get getTempImagePath => _tempFileImagePath;

  bool get getimagestatus => _updatedImagestatus;

  void statusUpdateImage() {
    _updatedImagestatus = !_updatedImagestatus;
  }

  //
  void updateTempFileImagePath(File imagePath) {
    _tempFileImagePath = imagePath;
    // _users[i].userFileImagePath = imagePath;
    notifyListeners();
  }
  ...
  void blockTrue(int i) {
    _users[i].isBlocked = true;
    notifyListeners();
  }
  ...
  void updateUserData(int index, User user) {
    //_users.add(user);
